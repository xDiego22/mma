...
<body>
   ...
   <div class="container border mt-4 shadow p-3 mb-4 bg-white rounded" style="width:85%;">
      ...
      <div class="container p3">
            ...
            <div class="row">
               <div class="col">
                     <p class="font-weight-normal text-justify">
                        En el menu, Al presionar sobre la opcion: <button class="btn btn-outline-dark btn-sm"><img src="img/iconos/atleta.png" style="width:30px;margin-right:10px;">Personal</button>
                  </p>
                     </p>
               </div>
            </div>
