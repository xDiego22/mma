        ...
        <div class="form">
            ...
            <div class="row mb-4">
                ...
                <div class="col-md-12 mb-4">
                    ...
                    <input class="form-control" maxlength="15" type="password" name="contrasena" id="contrasena" placeholder="Ej: &quot;15345987&quot;">
                    <span id="scontrasena" style="color: #ff0000;"></span>
                </div>
                <div class="col-md-12">
                    <label for="contrasena2">Confirmar contraseña</label>
                    <input class="form-control" maxlength="15" type="password" name="contrasena2" id="contrasena2" placeholder="Ej: &quot;15345987&quot;">
