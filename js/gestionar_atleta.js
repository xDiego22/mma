$(document).ready(function () {
	...
	$("#cedula_atleta").on("keyup", function(){
		validarkeyup(/^[0-9]{7,8}$/, $(this),$("#scedula_atleta"),"Debe ser formato (15345987)");
	});
	...
	$("#nombres_atleta").on("keyup", function(){
		validarkeyup(/^[A-Za-z\b\s\u00e1\u00c1\u00e9\u00c9\u00ed\u00cd\u00f3\u00d3\u00fa\u00da\u00f1\u00d1]{2,25}$/, $(this), $("#snombres_atleta"), "Introduzca nombres de manera correcta");
	});
	...
	$("#apellidos_atleta").on("keyup", function(){
		validarkeyup(/^[A-Za-z\b\s\u00e1\u00c1\u00e9\u00c9\u00ed\u00cd\u00f3\u00d3\u00fa\u00da\u00f1\u00d1]{2,25}$/, $(this), $("#sapellidos_atleta"), "Introduzca apellidos de manera correcta");
	});
	...
	$("#peso_atleta").on("keyup", function(){
		validarkeyup(/^[0-9]{2,3}[.]{0,1}[0-9]{0,1}$/,$(this),$("#speso_atleta"),"Debe ser formato (Ej: 56.4)");
	});
	...
	$("#estatura_atleta").on("keyup", function(){
		validarkeyup(/^[0-3]{1}[.]{1}[0-9]{1,2}$/,$(this),$("#sestatura_atleta"),"Ingrese una estatura valida... Debe ser formato (Ej: 1.68)");
	});	
	...
	$("#telefono_atleta").on("keyup", function(){
		validarkeyup(/^[0-9]{11}$/,$(this),$("#stelefono_atleta"),"Debe ser formato (04141234567)");
	});
	...
	$("#entrenador_atleta").on("keyup", function(){
		validarkeyup(/^[A-Za-z\b\s\u00e1\u00c1\u00e9\u00c9\u00ed\u00cd\u00f3\u00d3\u00fa\u00da\u00f1\u00d1]{2,25}$/, $(this), $("#sentrenador_atleta"), "Introduzca nombre de manera correcta");
	});
...
function validarboton() {
	...
	//ningun campo
	if (validarkeyup(/^[0-9]{7,8}$/, $("#cedula_atleta"), $("#scedula_atleta"), "Debe ser formato (15345987)") == false &&
		validarkeyup(/^[A-Za-z\b\s\u00e1\u00c1\u00e9\u00c9\u00ed\u00cd\u00f3\u00d3\u00fa\u00da\u00f1\u00d1]{5,40}$/, $("#nombres_atleta"), $("#snombres_atleta"), "Introduzca nombres de manera correcta") == false &&
		validarkeyup(/^[A-Za-z\b\s\u00e1\u00c1\u00e9\u00c9\u00ed\u00cd\u00f3\u00d3\u00fa\u00da\u00f1\u00d1]{5,40}$/, $("#apellidos_atleta"), $("#sapellidos_atleta"), "Introduzca apellidos de manera correcta") == false &&
		validarkeyup(/^[0-9]{2,3}[.]{0,1}[0-9]{0,1}$/, $("#peso_atleta"), $("#speso_atleta"), "Debe ser formato (Ej: 56.4)") == false &&
		validarkeyup(/^[0-3]{1}[.]{1}[0-9]{1,2}$/, $("#estatura_atleta"), $("#sestatura_atleta"), "Ingrese una estatura valida... Debe ser formato (Ej: 1.68)") == false &&
		$("#fecha_atleta").val() == "" &&
		$("#club_atleta").val() == "" &&
		validarkeyup(/^[0-9]{11}$/, $("#telefono_atleta"), $("#stelefono_atleta"), "Debe ser formato (04141234567)") == false &&
		$("#sexo_atleta").val() == "" &&
		$("#deporte_atleta").val() == "" &&
		$("#categoria_atleta").val() == "" &&
		$("#fecha_ingreso_atleta").val() == "" &&
		validarkeyup(/^[A-Za-z\b\s\u00e1\u00c1\u00e9\u00c9\u00ed\u00cd\u00f3\u00d3\u00fa\u00da\u00f1\u00d1]{2,25}$/, $("#entrenador_atleta"), $("#sentrenador_atleta"), "Introduzca nombre de manera correcta") == false) {
		mensajemodal("NINGUN CAMPO HA SIDO COMPLETADO");
		return false;
	}
	
	//solo telefono
	else if (validarkeyup(/^[0-9]{11}$/,$("#telefono_atleta"),$("#stelefono_atleta"),"Debe ser formato (04141234567)")==false) {
	...
	//solo estatura
	else if (validarkeyup(/^[0-3]{1}[.]{1}[0-9]{1,2}$/,$("#estatura_atleta"),$("#sestatura_atleta"),"Ingrese una estatura valida... Debe ser formato (Ej: 1.68)") == false) {
		mensajemodal("ERROR EN ESTATURA");
		return false;
	}

	//solo peso
	else if (validarkeyup(/^[0-9]{2,3}[.]{0,1}[0-9]{0,1}$/,$("#peso_atleta"),$("#speso_atleta"),"Debe ser formato (Ej: 56.4)") == false) {
		mensajemodal("ERROR EN PESO");
		return false;
	}

	//solo apellidos
	else if (validarkeyup(/^[A-Za-z\b\s\u00e1\u00c1\u00e9\u00c9\u00ed\u00cd\u00f3\u00d3\u00fa\u00da\u00f1\u00d1]{2,25}$/, $("#apellidos_atleta"), $("#sapellidos_atleta"), "Introduzca apellidos de manera correcta") == false) {
		mensajemodal("ERROR EN APELLIDO");
		return false;
	}

	//solo nombres
	else if (validarkeyup(/^[A-Za-z\b\s\u00e1\u00c1\u00e9\u00c9\u00ed\u00cd\u00f3\u00d3\u00fa\u00da\u00f1\u00d1]{2,25}$/, $("#nombres_atleta"), $("#snombres_atleta"), "Introduzca nombres de manera correcta") == false) {
		mensajemodal("ERROR EN NOMBRE");
		return false;
	}

	//solo cedula
	else if (validarkeyup(/^[0-9]{7,8}$/, $("#cedula_atleta"),$("#scedula_atleta"),"Debe ser formato (15345987)") == false) {
	...
	else if (validarkeyup(/^[A-Za-z\b\s\u00e1\u00c1\u00e9\u00c9\u00ed\u00cd\u00f3\u00d3\u00fa\u00da\u00f1\u00d1]{2,25}$/, $("#entrenador_atleta"), $("#sentrenador_atleta"), "Introduzca nombre de manera correcta") == false) {
...
function enviaAjax(datos,accion){
	...
	$.ajax({ 
            ...
            success: function(respuesta) {//si resulto exitosa la transmision
				...
				}else if(accion=='registrar_atletas'){
					try{
...
function modalmodificar(fila) {
	...
	$("#imagen").prop("src", "img/atletas/" + $(linea).find("td:eq(3)").text() + ".png");
...
function elimina(fila){
	...
	enviaAjax(datos,'eliminar_atletas');
